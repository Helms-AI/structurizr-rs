...
cargo run -- export --workspace examples/small/startup-saas/workspace.dsl --format json
cargo run -- export --workspace examples/small/startup-saas/workspace.dsl --format plantuml
```
...
- Explore medium examples in `/examples/medium/` for more complex systems
- Check large examples in `/examples/large/` for enterprise-scale architectures
