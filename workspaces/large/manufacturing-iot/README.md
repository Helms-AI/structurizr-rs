...
### Render All Views
```bash
cargo run -- render --workspace workspaces/large/manufacturing-iot/workspace.dsl --output ./manufacturing-diagrams
```

### Interactive Web View
```bash
cargo run -- serve --workspace workspaces/large/manufacturing-iot/workspace.dsl --port 8080
```
