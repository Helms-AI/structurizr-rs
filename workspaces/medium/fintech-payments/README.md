...
```bash
# Validate the DSL
cargo run -- validate workspaces/medium/fintech-payments/workspace.dsl

# Render diagrams
cargo run -- render --workspace workspaces/medium/fintech-payments/workspace.dsl --output ./output

# Serve interactively
cargo run -- serve --workspace workspaces/medium/fintech-payments/workspace.dsl --port 8080
```
